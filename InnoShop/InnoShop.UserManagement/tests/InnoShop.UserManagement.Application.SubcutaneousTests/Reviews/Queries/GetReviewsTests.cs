...
public class GetReviewsTests(MediatorFactory mediatorFactory)
{
    ...
    public async Task GetReviews_ForTargetUser_ShouldReturnReviews()
    {
        ...
        var author = UserFactory.CreateUserWithProfile(Email.Create("a@test.com").Value);
        ...
        var result1 = await mediator.Send(ReviewCommandFactory.CreateCreateReviewCommand(target.Id, 5, "123"));
