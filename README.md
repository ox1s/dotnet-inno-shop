...
**InnoShop** - учебный проект магазина б/у гаджетов, построенный на .NET 10, .NET Aspire и принципах DDD/Clean Architecture.

---

## 🏗 Архитектура

В основе системы лежит оркестратор **.NET Aspire**, управляющий жизненным циклом сервисов. Коммуникация между User Service и Product Service осуществляется через шину сообщений RabbitMQ, а данные хранятся в изолированных базах PostgreSQL.
...
Архитектура приложения строго следует принципам Domain-Driven Design, разделяя логику на агрегаты, сущности и объекты-значения (Value Objects).
